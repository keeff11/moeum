...
-- ---------------------------------------------------------------------
-- 환불 계좌 — /me/refund-account. 구매자당 1건 (V15 · D-057)
--
-- 1차금 결제(/pay)의 선행 조건이다. 판매 유형을 가리지 않는다 — 단독(재고) 판매도
-- 같이 받는다. 정산이 끝난 뒤의 환불(S14 · B8-C3)은 결제 수단으로 되돌릴 수 없어
-- 돈을 보낼 곳이 여기밖에 없다.
--
-- 배송지와 달리 스냅샷을 뜨지 않는다. 환불은 몇 주 뒤에 일어나고, 그때 살아 있는
-- 계좌로 보내야 한다 — 주문 시점 값을 굳히면 해지된 계좌로 보내게 된다.
-- ---------------------------------------------------------------------
